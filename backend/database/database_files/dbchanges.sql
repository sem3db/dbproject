UPDATE `cse_21`.`review`
SET
`review_state` = '3' WHERE
(`review_id` = '1');
UPDATE `cse_21`.`review`
SET
`review_state` = '4' WHERE
(`review_id` = '2');
UPDATE `cse_21`.`review`
SET
`review_state` = '1' WHERE
(`review_id` = '3');
UPDATE `cse_21`.`review`
SET
`review_state` = '4' WHERE
...
ALTER TABLE `cse_21`.`review`
ADD CHECK
(review_state>=1 AND review_state<=5) ;
...
((`customer_type` in
(_utf8mb4'Registered',_utf8mb4'Guest'))),
  CONSTRAINT `chk_deli_meth` CHECK
((`delivery_method` in
(_utf8mb4'In_store_pickup',_utf8mb4'Courier',_utf8mb4'Postal'))),
  CONSTRAINT `chk_pay_meth` CHECK
((`payment_method` in
(_utf8mb4'CashONDelivery',_utf8mb4'VISA',_utf8mb4'PayPal')))
...
productorder`
VALUES
  (1, '2021-02-27 13:18:46', 1, 'Guest', 'VISA', 300000.00, 'delivered', 'Postal', '2021-03-11', NULL),
  (2, '2021-02-27 13:18:46', 1, 'Registered', 'VISA', 400000.00, 'delivered', 'Postal', '2021-03-11', ''),
  (3, '2021-02-27 13:18:46', 2, 'Registered', 'VISA', 200000.00, 'delivered', 'Postal', '2021-03-11', NULL),
  (4, '2021-02-07 13:18:46', 3, 'Registered', 'PayPal', 100000.00, 'delivered', 'Courier', '2021-03-11', NULL),
  (5, '2021-04-07 13:18:46', 3, 'Registered', 'VISA', NULL, NULL, NULL, NULL, NULL),
  (6, '2021-05-07 13:18:46', 5, 'Registered', 'VISA', NULL, NULL, NULL, NULL, NULL),
  (7, '2021-06-07 13:18:46', 6, 'Registered', 'VISA', NULL, NULL, NULL, NULL, NULL),
  (8, '2021-07-07 13:18:46', 7, 'Registered', 'VISA', NULL, NULL, NULL, NULL, NULL),
  (9, '2021-08-07 13:18:46', 8, 'Registered', 'VISA', NULL, NULL, NULL, NULL, NULL),
  (10, '2021-09-07 13:18:46', 4, 'Registered', 'VISA', NULL, NULL, NULL, NULL, NULL),
