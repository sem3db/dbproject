            ...
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <Variant
                  type="radio"
                  vari={varinatKeys[0]}
                  value={product.vary[varinatKeys[0]]}
                  arr={
                    product.variants && product.variants[varinatKeys[0]]
              ...
              <ListGroup.Item>
                <Variant
                  type="dropdown"
                  vari={varinatKeys[1]}
                  value={product.vary[varinatKeys[1]]}
                  arr={
                    product.variants && product.variants[varinatKeys[1]]
